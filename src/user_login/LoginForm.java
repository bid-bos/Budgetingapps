...
public class LoginForm extends javax.swing.JFrame {
    ...
    public void focusGained(FocusEvent e) {
        if (jTextField1.getText().equals("Masukkan Username")) {
            jTextField1.setText("");
    ...
    // Placeholder untuk Password
        ...
        jPasswordField1.setEchoChar((char) 0); // Placeholder terlihat sebagai teks biasa
        jPasswordField1.addFocusListener(new FocusAdapter() {
    @Override
    public void focusGained(FocusEvent e) {
        if (new String(jPasswordField1.getPassword()).equals("Password")) {
            jPasswordField1.setText("");
            jPasswordField1.setEchoChar('\u2022'); // Karakter bintang
    ...
    public void focusLost(FocusEvent e) {
        if (new String(jPasswordField1.getPassword()).isEmpty()) {
            jPasswordField1.setText("Password");
            jPasswordField1.setEchoChar((char) 0); // Kembali ke placeholder
            jPasswordField1.setForeground(Color.GRAY);
        }
    }
});
